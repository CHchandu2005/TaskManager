...
const Inprogress = () => {
    ...
    const fetchTasks = async () => {
        try {
            ...
            const response = await fetch('http://localhost:5000/api/task/getinprogresstasks', {
                method: 'GET',
                headers: {
    ...
    useEffect(() => {
        fetchTasks();
    }, []); // Add empty dependency array to run the effect once when component mounts
...
{openCard && task && (
            ...
            <div className="mt-6">
                <h2 className="text-2xl font-semibold mb-4">Inprogress Tasks</h2>
